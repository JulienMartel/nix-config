...

{
  ...
  haus.ai.autoMode.environment = [
    "### Org-wide"
    "**Organization**: hausfold, a one-person org. github.com/hausfold/* (haus, pounce, nebelung, scruff, trill, perch, snug, factory, holt, ops, workshop, hausfold.co, homebrew-tap) and github.com/julienmartel/* are all owned solo by the user, who is the only committer and the only reviewer. Every checkout under ~/code/workshop, ~/code and ~/.config/nix is theirs."
