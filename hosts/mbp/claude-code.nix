...

{
  ...
  haus.ai.autoMode.environment = [
    "### Org-wide"
    "**Organization**: hausfold, a one-person org. github.com/hausfold/* (haus, pounce, nebelung, scruff, scruff-swift, trill, perch, snug, factory, ops, producer-desktop, website, workshop, hausfold.co, homebrew-tap) and github.com/julienmartel/* are all owned solo by the user, who is the only committer and the only reviewer. Every checkout under ~/code/workshop, ~/code and ~/.config/nix is theirs."
    ...
    "**Org-specific CLIs**: haus, bench, scruff, wt, trill, perch, pounce, tart, secretspec, gh, nix, darwin-rebuild — all the user's own infrastructure."
  ];
