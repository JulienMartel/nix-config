...
| Thing | Where | Notes |
|---|---|---|
| Project instructions | `AGENTS.md`, imported above | Claude Code reads only `CLAUDE.md`, so this file exists purely to import it. The *global* instructions (`~/.claude/CLAUDE.md`) are generated from `haus.ai.instructions`, whose body is `hosts/mbp/instructions.md` — a different file, edited there. |
